...
class Group
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Seyon\PHPBB3\UserBundle\Entity\User", cascade={"remove"})
     * @ORM\JoinColumn(name="user_id", referencedColumnName="user_id", unique=false, onDelete="CASCADE")
     */
   protected $user;
    
    /**
     * @ORM\ManyToOne(targetEntity="\Seyon\PHPBB3\UserBundle\Entity\Group", cascade={"remove"})
